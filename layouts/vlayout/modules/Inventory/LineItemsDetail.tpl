        ...
        <table class="table table-bordered">
            <tr>
                ...
                {for $i=1 to 36}
                    {if $i <= $FINAL_DETAILS.jangka_waktu_um}
                        <tr>
                                ...
                                <td>
                                        <span class="pull-right">
                                                {if $UANGMUKA[$i-1].um_due_date}{DateTimeField::convertToUserFormat($UANGMUKA[$i-1].um_due_date)}{/if}
                                        </span>
                                </td>
                                <td>
                                        <span class="pull-right">
                                                {if $UANGMUKA[$i-1].um}{$UANGMUKA[$i-1].um}{else}0.00{/if}
                                        </span>
                                </td>
                        </tr>
                    {/if}
                ...
                <tr>
                        ...
                        <td>
                                <span class="pull-right">
                                        {if $FINAL_DETAILS.jamsostek}{$FINAL_DETAILS.jamsostek}{else}0.00{/if}
                                </span>
                        </td>
                </tr>
                <tr>
                        ...
                        <td>
                                <span class="pull-right">
                                        {if $FINAL_DETAILS.pinjaman}{$FINAL_DETAILS.pinjaman}{else}0.00{/if}
                                </span>
                        </td>
                </tr>
                <tr>
                        ...
                        <td>
                                <span class="pull-right">
                                        <b>{if $FINAL_DETAILS.totalbayar}{$FINAL_DETAILS.totalbayar}{else}0.00{/if}</b>
                                </span>
                        </td>
                </tr>
        </table>
