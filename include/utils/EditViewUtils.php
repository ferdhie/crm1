...
function getAssociatedProducts($module,$focus,$seid='')
{
	...
	//To set the nup -> arif
	$nup = ($focus->column_fields['nup'] != '')?$focus->column_fields['nup']:'0.00';
	$nup = number_format($nup, $no_of_decimal_places,'.','');
	$product_Detail[1]['final_details']['nup'] = $nup;

	//To set the nup_due_date -> arif
	$nup_due_date = ($focus->column_fields['nup_due_date'] != '')?$focus->column_fields['nup_due_date']:'';
	//$nup_due_date = number_format($nup, $no_of_decimal_places,'.','');
	$product_Detail[1]['final_details']['nup_due_date'] = $nup_due_date;


	//To set the bookingfee -> arif
	$bookingfee = ($focus->column_fields['bookingfee'] != '')?$focus->column_fields['bookingfee']:'0.00';
	$bookingfee = number_format($bookingfee, $no_of_decimal_places,'.','');
	$product_Detail[1]['final_details']['bookingfee'] = $bookingfee;

	//To set the bookingfee_due_date -> arif
	$bookingfee_due_date = ($focus->column_fields['bookingfee_due_date'] != '')?$focus->column_fields['bookingfee_due_date']:'';
	$product_Detail[1]['final_details']['bookingfee_due_date'] = $bookingfee_due_date;
        
	$angsuran1 = ($focus->column_fields['angsuran1'] != '')?$focus->column_fields['angsuran1']:'0.00';
	$angsuran1 = number_format($angsuran1, $no_of_decimal_places,'.','');
	$product_Detail[1]['final_details']['angsuran1'] = $angsuran1;
        
	$angsuran2 = ($focus->column_fields['angsuran2'] != '')?$focus->column_fields['angsuran2']:'0.00';
	$angsuran2 = number_format($angsuran2, $no_of_decimal_places,'.','');
	$product_Detail[1]['final_details']['angsuran2'] = $angsuran1;
        
	$angsuran3 = ($focus->column_fields['angsuran3'] != '')?$focus->column_fields['angsuran3']:'0.00';
	$angsuran3 = number_format($angsuran3, $no_of_decimal_places,'.','');
	$product_Detail[1]['final_details']['angsuran3'] = $angsuran3;

	/*
         * Pindahkan ke modules/SalesOrder/models/Record.php
        //To set the um1 -> arif
	$um1 = ($focus->column_fields['um1'] != '')?$focus->column_fields['um1']:'0.00';
	$um1 = number_format($um1, $no_of_decimal_places,'.','');
	$product_Detail[1]['final_details']['um1'] = $um1;

	//To set the um1_due_date -> arif
	$um1_due_date = ($focus->column_fields['um1_due_date'] != '')?$focus->column_fields['um1_due_date']:'';
	$product_Detail[1]['final_details']['um1_due_date'] = $um1_due_date;

	//To set the um2 -> arif
	$um2 = ($focus->column_fields['um2'] != '')?$focus->column_fields['um2']:'0.00';
	$um2 = number_format($um2, $no_of_decimal_places,'.','');
	$product_Detail[1]['final_details']['um2'] = $um2;

	//To set the um2_due_date -> arif
	$um2_due_date = ($focus->column_fields['um2_due_date'] != '')?$focus->column_fields['um2_due_date']:'';
	$product_Detail[1]['final_details']['um2_due_date'] = $um2_due_date;

	//To set the um3 -> arif
	$um3 = ($focus->column_fields['um3'] != '')?$focus->column_fields['um3']:'0.00';
	$um3 = number_format($um3, $no_of_decimal_places,'.','');
	$product_Detail[1]['final_details']['um3'] = $um3;

	//To set the um3_due_date -> arif
	$um3_due_date = ($focus->column_fields['um3_due_date'] != '')?$focus->column_fields['um3_due_date']:'';
	$product_Detail[1]['final_details']['um3_due_date'] = $um3_due_date;

	//To set the um3 -> arif
	$um4 = ($focus->column_fields['um4'] != '')?$focus->column_fields['um4']:'0.00';
	$um4 = number_format($um4, $no_of_decimal_places,'.','');
	$product_Detail[1]['final_details']['um4'] = $um4;

	//To set the um3_due_date -> arif
	$um4_due_date = ($focus->column_fields['um4_due_date'] != '')?$focus->column_fields['um4_due_date']:'';
	$product_Detail[1]['final_details']['um4_due_date'] = $um4_due_date;
        
	//To set the um3 -> arif
	$um5 = ($focus->column_fields['um5'] != '')?$focus->column_fields['um5']:'0.00';
	$um5 = number_format($um5, $no_of_decimal_places,'.','');
	$product_Detail[1]['final_details']['um5'] = $um5;

	//To set the um3_due_date -> arif
	$um5_due_date = ($focus->column_fields['um5_due_date'] != '')?$focus->column_fields['um5_due_date']:'';
	$product_Detail[1]['final_details']['um5_due_date'] = $um5_due_date;
        
	//To set the um3 -> arif
	$um6 = ($focus->column_fields['um6'] != '')?$focus->column_fields['um6']:'0.00';
	$um6 = number_format($um6, $no_of_decimal_places,'.','');
	$product_Detail[1]['final_details']['um6'] = $um6;

	//To set the um3_due_date -> arif
	$um6_due_date = ($focus->column_fields['um6_due_date'] != '')?$focus->column_fields['um6_due_date']:'';
	$product_Detail[1]['final_details']['um6_due_date'] = $um6_due_date;
        */
        
	//To set the jamsostek -> arif
	$jamsostek = ($focus->column_fields['jamsostek'] != '')?$focus->column_fields['jamsostek']:'0.00';
	$jamsostek = number_format($jamsostek, $no_of_decimal_places,'.','');
	$product_Detail[1]['final_details']['jamsostek'] = $jamsostek;

	//To set the jamsostek_due_date -> arif
	$jamsostek_due_date = ($focus->column_fields['jamsostek_due_date'] != '')?$focus->column_fields['jamsostek_due_date']:'';
	$product_Detail[1]['final_details']['jamsostek_due_date'] = $jamsostek_due_date;


	//To set the carapinjam -> arif
	$carapinjam = ($focus->column_fields['carapinjam'] != '')?$focus->column_fields['carapinjam']:'';
	$product_Detail[1]['final_details']['carapinjam'] = $carapinjam;

	//To set the pinjaman_due_date -> arif
	$pinjaman_due_date = ($focus->column_fields['pinjaman_due_date'] != '')?$focus->column_fields['pinjaman_due_date']:'';
	$product_Detail[1]['final_details']['pinjaman_due_date'] = $pinjaman_due_date;

	//To set the pinjaman -> arif
	$pinjaman = ($focus->column_fields['pinjaman'] != '')?$focus->column_fields['pinjaman']:'0.00';
	$pinjaman = number_format($pinjaman, $no_of_decimal_places,'.','');
	$product_Detail[1]['final_details']['pinjaman'] = $pinjaman;

	//To set the totalbayar -> arif
	$totalbayar = ($focus->column_fields['totalbayar'] != '')?$focus->column_fields['totalbayar']:'0.00';
	$totalbayar = number_format($totalbayar, $no_of_decimal_places,'.','');
	$product_Detail[1]['final_details']['totalbayar'] = $totalbayar;

	$jangka_waktu_um = ($focus->column_fields['jangka_waktu_um'] != '')?$focus->column_fields['jangka_waktu_um']:0;
	$product_Detail[1]['final_details']['jangka_waktu_um'] = $jangka_waktu_um;
