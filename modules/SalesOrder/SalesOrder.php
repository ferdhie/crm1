...
class SalesOrder extends CRMEntity {
	...
	function SalesOrder() {
        ...
        function get_payments($id) {
            ...
            $query = "SELECT vtiger_paymentmdl.* FROM vtiger_paymentmdl,vtiger_crmentity WHERE vtiger_paymentmdl.paymentmdlid=vtiger_crmentity.crmid AND vtiger_paymentmdl.salesorder_id = '$id' AND vtiger_crmentity.deleted=0";
            return GetRelatedList('SalesOrder','Paymentmdl',$focus,$query,$button,$returnset);
        }
