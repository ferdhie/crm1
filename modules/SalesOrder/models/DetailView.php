...
class SalesOrder_DetailView_Model extends Inventory_DetailView_Model {
	...
	public function getDetailViewLinks($linkParams) {
		...
		if($currentUserModel->hasModuleActionPermission($paymentModuleModel->getId(), 'EditView')) {
			$basicActionLink = array(
				'linktype' => 'DETAILVIEW',
				'linklabel' => vtranslate('LBL_CREATE').' '.vtranslate($paymentModuleModel->getSingularLabelKey(), 'Paymentmdl'),
