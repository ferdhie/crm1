...
class PriceBooks_Record_Model extends Vtiger_Record_Model {
        ...
        /**
         * Return the URL for detailed pricebook info
         * @see modules/PriceBooks/actions/ProductListPrice.php
         */
        function getPricebookInfoURL() {
            $url = $this->getProductListPriceURL() . "&fullinfo=true";
            return $url;
        }
